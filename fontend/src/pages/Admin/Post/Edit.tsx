...
import { CREATE_POST, GET_POST, GET_POSTS, UPDATE_POST } from "../../../api/post";
...
const EditPost = () => {
  ...
  const { data: post } = useQuery(GET_POST, { variables: { id: parsedId } });
          ...
          <Form.Item wrapperCol={{ span: 12, offset: 6 }}>
            <Space className="flex flex-col md:flex-row">
              ...
              >
                ...
                <Text className=" text-[#fff] ml-2">Update</Text>
              </Button>
              <Button
